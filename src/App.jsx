...
const PaymentFail = React.lazy(() => import('./pages/PaymentFail.jsx'))
...
const SharedWorkflowPage = React.lazy(() => import('./pages/share/[token].tsx'))
    ...
    <Router>
      <div className="min-h-screen bg-background">
        <Routes>
          ...
          <Route path="/payment/fail" element={<Suspense fallback={<PageLoader />}><PaymentFail /></Suspense>} />

          {/* 공유된 워크플로우 페이지 (레이아웃 없음) */}
          <Route path="/share/:token" element={<Suspense fallback={<PageLoader />}><SharedWorkflowPage /></Suspense>} />
