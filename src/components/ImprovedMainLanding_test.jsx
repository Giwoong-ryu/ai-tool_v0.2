  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 min-h-screen">
      ...
      <section className="relative pt-32 pb-24 px-4 overflow-hidden bg-gradient-to-br from-primary-600 via-[#4f28ff] to-primary-900">
        {/* 노이즈 텍스처 오버레이 */}
        <div
          className={`absolute inset-0 opacity-10 bg-[url('data:image/svg+xml,%3Csvg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"%3E%3Cfilter id="noiseFilter"%3E%3CfeTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="4" stitchTiles="stitch"/%3E%3C/filter%3E%3Crect width="100%25" height="100%25" filter="url(%23noiseFilter)"/%3E%3C/svg%3E')]`}
        ></div>
            ...
            <div className="text-center lg:text-left space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center pt-6 animate-in slide-in-from-bottom-6 duration-700 delay-200">
                <Button
                  ...
                  onClick={() =>
                    document
                      .getElementById("interactive-hub")
            ...
            <Card className="group relative overflow-hidden bg-neutral-0/90 backdrop-blur-lg border border-neutral-200/50 shadow-glass hover:shadow-elev transition-all duration-500 transform hover:-translate-y-2">
              <CardContent className="p-12 text-center space-y-8">
                ...
                <p className="text-slate-600 leading-relaxed text-lg">
                  복잡한 프롬프트 작성법을 배울 필요 없이
                  <br />
                  <span className="font-semibold text-slate-800">
                    몇 번의 클릭만으로 전문가급 질문 완성
                  </span>
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-6 group">
              ...
              <div className="space-y-3">
                <h4 className="font-body text-body-lg font-semibold text-neutral-700">
                  합격률 향상
                </h4>
                <div className="font-display text-display-md font-bold text-accent-500">
                  78%
                </div>
            ...
            <div className="text-center space-y-6 group">
              ...
              <div className="space-y-3">
                ...
                <div className="font-display text-display-md font-bold text-primary-600">
                  90%
                </div>
                <p className="font-body text-body-sm text-neutral-700">
                  평균 3시간 → 30분
      ...
      <section className="py-48 bg-gradient-to-br from-neutral-900 via-primary-900 to-primary-900 relative overflow-hidden">
        {/* 노이즈 텍스처 오버레이 */}
        <div
          className={`absolute inset-0 opacity-5 bg-[url('data:image/svg+xml,%3Csvg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"%3E%3Cfilter id="noiseFilter"%3E%3CfeTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="4" stitchTiles="stitch"/%3E%3C/filter%3E%3Crect width="100%25" height="100%25" filter="url(%23noiseFilter)"/%3E%3C/svg%3E')]`}
        ></div>
